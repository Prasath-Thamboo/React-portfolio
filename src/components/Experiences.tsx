...
const experiences = [
    {
        id: 1,
        role: "Chef de projet dans le développement web",
        company: "Navilone",
        period: "Oct 2024 - Présent",
        description: [
            "Gestion de projets web : applications, sites web",
            "Optimisation du développement en intégrant des outils modernes",
        ],
        image: google,
    },
    {
    ...
    {
        id: 3,
        role: "Employé polyvalent - Développeur Front-end",
        company: "Fydgest",
        period: "Jan 2018 - Déc 2022",
        description: [
            "Développement d'un site vitrine moderne et intuitif",
            "Implémenter de contenus pour le développement de l'entreprise",
        ],
        image: amazon,
    },
];
